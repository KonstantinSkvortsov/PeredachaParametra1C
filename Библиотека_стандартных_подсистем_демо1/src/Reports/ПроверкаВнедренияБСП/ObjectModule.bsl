...
Процедура Подключаемый_КонтактнаяИнформация_ПроверитьВнедрение()
	...
	ПараметрыПроверки.СтрокаКода             = "УправлениеКонтактнойИнформациейКлиент.АвтоПодбор";
...
Процедура Подключаемый_РаботаСФайлами_ПроверитьВнедрение()
	...
	МассивИсточников.Добавить(СоставПодписокПоОбработчику("РаботаСФайлами.ОпределитьФормуПрисоединенногоФайла"));
...
Процедура ПроверитьСоставПлановОбмена()
	...
	Для Каждого ПланОбмена Из ПланыОбменаПодсистемы Цикл
		...
		Если ПланОбмена.РаспределеннаяИнформационнаяБаза Тогда
			...
			ОбъектыИсключенияПланаОбмена = ОбщегоНазначенияКлиентСервер.СкопироватьМассив(ОбъектыИсключенияПланаОбменаЛюбогоРИБ);
